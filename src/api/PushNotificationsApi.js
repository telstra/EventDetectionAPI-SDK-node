...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/NotificationPayload', 'model/PushNotificationObj'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/NotificationPayload'), require('../model/PushNotificationObj'));
  } else {
    // Browser globals (root is window)
    if (!root.TelstraEventDetection) {
      root.TelstraEventDetection = {};
    }
    root.TelstraEventDetection.PushNotificationsApi = factory(root.TelstraEventDetection.ApiClient, root.TelstraEventDetection.NotificationPayload, root.TelstraEventDetection.PushNotificationObj);
  }
}(this, function(ApiClient, NotificationPayload, PushNotificationObj) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the pushNotifications operation.
     * @callback module:api/PushNotificationsApi~pushNotificationsCallback
     * @param {String} error Error message, if any.
     * @param {module:model/PushNotificationObj} data The data returned by the service call.
     ...
     * @param {module:model/NotificationPayload} body Application Id, MSISDN, Event Id and Event Date
     * @param {module:api/PushNotificationsApi~pushNotificationsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/PushNotificationObj}
     */
    this.pushNotifications = function(contentType, body, callback) {
      var postBody = body;

      // verify the required parameter 'contentType' is set
      if (contentType === undefined || contentType === null) {
        throw new Error("Missing the required parameter 'contentType' when calling pushNotifications");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling pushNotifications");
      }
      ...
      var returnType = PushNotificationObj;

      return this.apiClient.callApi(
        '/v1/eventdetection/events/notifications', 'POST',
