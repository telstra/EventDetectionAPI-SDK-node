...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ResisterPhoneNumberList', 'model/SubscriptionObj', 'model/UnregisterRequestObj'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ResisterPhoneNumberList'), require('../model/SubscriptionObj'), require('../model/UnregisterRequestObj'));
  } else {
    // Browser globals (root is window)
    if (!root.TelstraEventDetection) {
      root.TelstraEventDetection = {};
    }
    root.TelstraEventDetection.RegistrationApi = factory(root.TelstraEventDetection.ApiClient, root.TelstraEventDetection.ResisterPhoneNumberList, root.TelstraEventDetection.SubscriptionObj, root.TelstraEventDetection.UnregisterRequestObj);
  }
}(this, function(ApiClient, ResisterPhoneNumberList, SubscriptionObj, UnregisterRequestObj) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/ResisterPhoneNumberList} data The data returned by the service call.
     ...
     * @param {module:model/SubscriptionObj} body Subscribe with a list of phone numbers, push notification URL (optional) and the event type.
     ...
     * data is of type: {@link module:model/ResisterPhoneNumberList}
     */
    this.register = function(body, callback) {
      ...
      var returnType = ResisterPhoneNumberList;

      return this.apiClient.callApi(
        '/v1/eventdetection/events', 'POST',
     ...
     * @callback module:api/RegistrationApi~unregisterCallback
     * @param {String} error Error message, if any.
     * @param {module:model/ResisterPhoneNumberList} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/String} eventType Event Type
     * @param {module:model/UnregisterRequestObj} body List of subscribed phone numbers and notification URL (optional)
     * @param {module:api/RegistrationApi~unregisterCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ResisterPhoneNumberList}
     */
    this.unregister = function(eventType, body, callback) {
      var postBody = body;

      // verify the required parameter 'eventType' is set
      if (eventType === undefined || eventType === null) {
        throw new Error("Missing the required parameter 'eventType' when calling unregister");
      }
      ...
      return this.apiClient.callApi(
        '/v1/eventdetection/events/{eventType}', 'DELETE',
        pathParams, queryParams, collectionQueryParams, headerParams, formParams, postBody,
        authNames, contentTypes, accepts, returnType, callback
      );
    }
