...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetSubscriptionResponse', 'model/PhoneNumberList'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GetSubscriptionResponse'), require('../model/PhoneNumberList'));
  } else {
    // Browser globals (root is window)
    if (!root.TelstraEventDetection) {
      root.TelstraEventDetection = {};
    }
    root.TelstraEventDetection.GetSubscriptionApi = factory(root.TelstraEventDetection.ApiClient, root.TelstraEventDetection.GetSubscriptionResponse, root.TelstraEventDetection.PhoneNumberList);
  }
}(this, function(ApiClient, GetSubscriptionResponse, PhoneNumberList) {
  'use strict';

  /**
   * GetSubscription service.
   * @module api/GetSubscriptionApi
   * @version 1.0.0
   */

  /**
   * Constructs a new GetSubscriptionApi. 
   * @alias module:api/GetSubscriptionApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/GetSubscriptionApi~getSubscriptionCallback
     ...
     * @param {module:model/PhoneNumberList} body List of subscribed phone numbers
     * @param {module:api/GetSubscriptionApi~getSubscriptionCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetSubscriptionResponse}
     */
    this.getSubscription = function(body, callback) {
      var postBody = body;

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling getSubscription");
      }
      ...
      return this.apiClient.callApi(
        '/v1/eventdetection/events/subscriptions', 'POST',
