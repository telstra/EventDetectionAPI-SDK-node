...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetEventResponse', 'model/PollingObj'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GetEventResponse'), require('../model/PollingObj'));
  } else {
    // Browser globals (root is window)
    if (!root.TelstraEventDetection) {
      root.TelstraEventDetection = {};
    }
    root.TelstraEventDetection.LongPollApi = factory(root.TelstraEventDetection.ApiClient, root.TelstraEventDetection.GetEventResponse, root.TelstraEventDetection.PollingObj);
  }
}(this, function(ApiClient, GetEventResponse, PollingObj) {
  'use strict';

  /**
   * LongPoll service.
   * @module api/LongPollApi
   * @version 1.0.0
   */

  /**
   * Constructs a new LongPollApi. 
   * @alias module:api/LongPollApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/LongPollApi~longpollCallback
     * @param {String} error Error message, if any.
     * @param {module:model/GetEventResponse} data The data returned by the service call.
     ...
     * @param {module:model/PollingObj} body List of MSISDNs to pull the events
     * @param {module:api/LongPollApi~longpollCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/GetEventResponse}
     */
    this.longpoll = function(eventType, body, callback) {
      var postBody = body;

      // verify the required parameter 'eventType' is set
      if (eventType === undefined || eventType === null) {
        throw new Error("Missing the required parameter 'eventType' when calling longpoll");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling longpoll");
      }
      ...
      var returnType = GetEventResponse;

      return this.apiClient.callApi(
        '/v1/eventdetection/events/{eventType}', 'POST',
