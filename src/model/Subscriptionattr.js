...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TelstraEventDetection.Subscriptionattr = factory(root.TelstraEventDetection.ApiClient);
  }
  ...
  /**
   * The Subscriptionattr model module.
   * @module model/Subscriptionattr
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Subscriptionattr</code>.
   * @alias module:model/Subscriptionattr
   * @class
   * @param msisdn {String} MSISDN
   * @param events {Array.<String>} Array of subscribed events
   * @param carrierName {String} Carrier name for the MSISDN
   */
  var exports = function(msisdn, events, carrierName) {
    var _this = this;
  ...
  /**
   * Constructs a <code>Subscriptionattr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Subscriptionattr} obj Optional instance to populate.
   * @return {module:model/Subscriptionattr} The populated <code>Subscriptionattr</code> instance.
   */
