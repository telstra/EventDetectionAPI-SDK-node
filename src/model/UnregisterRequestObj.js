...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TelstraEventDetection.UnregisterRequestObj = factory(root.TelstraEventDetection.ApiClient);
  }
  ...
  /**
   * The UnregisterRequestObj model module.
   * @module model/UnregisterRequestObj
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>UnregisterRequestObj</code>.
   * @alias module:model/UnregisterRequestObj
   * @class
   */
  ...
  /**
   * Constructs a <code>UnregisterRequestObj</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UnregisterRequestObj} obj Optional instance to populate.
   * @return {module:model/UnregisterRequestObj} The populated <code>UnregisterRequestObj</code> instance.
   */
