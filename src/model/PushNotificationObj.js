...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TelstraEventDetection.PushNotificationObj = factory(root.TelstraEventDetection.ApiClient);
  }
  ...
  /**
   * The PushNotificationObj model module.
   * @module model/PushNotificationObj
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>PushNotificationObj</code>.
   * @alias module:model/PushNotificationObj
   * @class
   * @param eventId {String} Event name
   * @param msisdn {String} MSISDN
   * @param eventDate {String} Timestamp indicating when the event occured
   */
  var exports = function(eventId, msisdn, eventDate) {
    var _this = this;
  ...
  /**
   * Constructs a <code>PushNotificationObj</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PushNotificationObj} obj Optional instance to populate.
   * @return {module:model/PushNotificationObj} The populated <code>PushNotificationObj</code> instance.
   */
  ...
  /**
   * Timestamp indicating when the event occured
