...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TelstraEventDetection.ServiceEventsAttr = factory(root.TelstraEventDetection.ApiClient);
  }
  ...
  /**
   * The ServiceEventsAttr model module.
   * @module model/ServiceEventsAttr
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>ServiceEventsAttr</code>.
   * @alias module:model/ServiceEventsAttr
   * @class
   * @param eventId {String} MSISDN
   * @param eventDate {String} Array of subscribed events
   */
  var exports = function(eventId, eventDate) {
    var _this = this;
  ...
  /**
   * Constructs a <code>ServiceEventsAttr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ServiceEventsAttr} obj Optional instance to populate.
   * @return {module:model/ServiceEventsAttr} The populated <code>ServiceEventsAttr</code> instance.
   */
