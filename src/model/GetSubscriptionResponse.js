...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Subscriptionattr'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Subscriptionattr'));
  } else {
    // Browser globals (root is window)
    if (!root.TelstraEventDetection) {
      root.TelstraEventDetection = {};
    }
    root.TelstraEventDetection.GetSubscriptionResponse = factory(root.TelstraEventDetection.ApiClient, root.TelstraEventDetection.Subscriptionattr);
  }
}(this, function(ApiClient, Subscriptionattr) {
  'use strict';
   ...
   * This is the interface to get subscription details for a phone number. The number must be a registered number. The response depends on the type of event..
   * @alias module:model/GetSubscriptionResponse
   * @class
   * @param subscriptions {Array.<module:model/Subscriptionattr>} Array containing the object with values for phone number and subscription attributes
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('subscriptions')) {
        obj['subscriptions'] = ApiClient.convertToType(data['subscriptions'], [Subscriptionattr]);
      }
    }
    return obj;
  }
  ...
  /**
   * Array containing the object with values for phone number and subscription attributes
   * @member {Array.<module:model/Subscriptionattr>} subscriptions
   */
