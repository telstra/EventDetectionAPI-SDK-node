...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Eventsattr'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Eventsattr'));
  } else {
    // Browser globals (root is window)
    if (!root.TelstraEventDetection) {
      root.TelstraEventDetection = {};
    }
    root.TelstraEventDetection.GetEventResponse = factory(root.TelstraEventDetection.ApiClient, root.TelstraEventDetection.Eventsattr);
  }
}(this, function(ApiClient, Eventsattr) {
  'use strict';
  ...
  /**
   * The GetEventResponse model module.
   * @module model/GetEventResponse
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GetEventResponse</code>.
   * This is the interface to get event details for a phone number. The number must be a registered number. The response depends on the type of event.
   * @alias module:model/GetEventResponse
   * @class
   * @param eventType {String} Name of the event
   * @param msisdns {Array.<module:model/Eventsattr>} Array containing the object with evnt attributes
   */
  var exports = function(eventType, msisdns) {
    var _this = this;

    _this['eventType'] = eventType;
    _this['msisdns'] = msisdns;
  };

  /**
   * Constructs a <code>GetEventResponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetEventResponse} obj Optional instance to populate.
   * @return {module:model/GetEventResponse} The populated <code>GetEventResponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('msisdns')) {
        obj['msisdns'] = ApiClient.convertToType(data['msisdns'], [Eventsattr]);
      }
    }
    return obj;
  }
  ...
  /**
   * Array containing the object with evnt attributes
   * @member {Array.<module:model/Eventsattr>} msisdns
   */
  exports.prototype['msisdns'] = undefined;
