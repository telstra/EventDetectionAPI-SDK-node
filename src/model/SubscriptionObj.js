...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TelstraEventDetection.SubscriptionObj = factory(root.TelstraEventDetection.ApiClient);
  }
  ...
  /**
   * The SubscriptionObj model module.
   * @module model/SubscriptionObj
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>SubscriptionObj</code>.
   * @alias module:model/SubscriptionObj
   * @class
   * @param msisdns {Array.<String>} List of Phone numbers
   * @param eventType {String} Event Type
   */
  var exports = function(msisdns, eventType) {
    var _this = this;
  ...
  /**
   * Constructs a <code>SubscriptionObj</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SubscriptionObj} obj Optional instance to populate.
   * @return {module:model/SubscriptionObj} The populated <code>SubscriptionObj</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('msisdns')) {
        obj['msisdns'] = ApiClient.convertToType(data['msisdns'], ['String']);
      }
