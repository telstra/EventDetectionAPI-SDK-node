...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.TelstraEventDetection.NotificationPayload = factory(root.TelstraEventDetection.ApiClient);
  }
  ...
  /**
   * The NotificationPayload model module.
   * @module model/NotificationPayload
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>NotificationPayload</code>.
   * @alias module:model/NotificationPayload
   * @class
   */
  ...
  /**
   * Constructs a <code>NotificationPayload</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/NotificationPayload} obj Optional instance to populate.
   * @return {module:model/NotificationPayload} The populated <code>NotificationPayload</code> instance.
   */
