...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ServiceEventsAttr'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ServiceEventsAttr'));
  } else {
    // Browser globals (root is window)
    if (!root.TelstraEventDetection) {
      root.TelstraEventDetection = {};
    }
    root.TelstraEventDetection.Eventsattr = factory(root.TelstraEventDetection.ApiClient, root.TelstraEventDetection.ServiceEventsAttr);
  }
}(this, function(ApiClient, ServiceEventsAttr) {
  'use strict';
  ...
  /**
   * The Eventsattr model module.
   * @module model/Eventsattr
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Eventsattr</code>.
   * @alias module:model/Eventsattr
   * @class
   * @param msisdn {String} MSISDN
   * @param mobileServiceEvents {Array.<module:model/ServiceEventsAttr>} Array of mobile events
   */
  var exports = function(msisdn, mobileServiceEvents) {
    var _this = this;

    _this['msisdn'] = msisdn;
    _this['mobileServiceEvents'] = mobileServiceEvents;
  };

  /**
   * Constructs a <code>Eventsattr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Eventsattr} obj Optional instance to populate.
   * @return {module:model/Eventsattr} The populated <code>Eventsattr</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('mobileServiceEvents')) {
        obj['mobileServiceEvents'] = ApiClient.convertToType(data['mobileServiceEvents'], [ServiceEventsAttr]);
      }
    }
    return obj;
  }
  ...
  /**
   * Array of mobile events
   * @member {Array.<module:model/ServiceEventsAttr>} mobileServiceEvents
   */
  exports.prototype['mobileServiceEvents'] = undefined;
